...
namespace Pizza
{
    public class ApplicationMessages
    {
        ...
        public const string VerificationCodeResent = "Verification code re sent";
        public const string UserNotFoundForGivenEmail = "Failed to find a user associated with the provided email.";
        public const string SignupComplete = "You did it! Signup complete :)";
