...
namespace Pizza.Models
{
    ...
    {
        private DatabaseContext storeDB = new DatabaseContext();
        ...
        public int AddToCartManually(int id)
        {
        ...
        private Item getItemFromModel(int id)
        {
            return storeDB.items.Where(i => i.id == id).FirstOrDefault();
        }
